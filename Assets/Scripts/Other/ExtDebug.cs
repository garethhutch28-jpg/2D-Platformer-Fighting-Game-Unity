...
public static class ExtDebug
{
    ...
    public static void DrawBoxCastOnHit(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Vector3 direction, float hitInfoDistance, Color color)
    {
        ...
        DrawBox(origin, halfExtents, orientation, color, 10f);
    }
    ...
    public static void DrawBoxCast2D(Vector2 origin, Vector2 size, float angle, Vector2 direction, float distance, Color color, float duration)
    {
        Quaternion angle_z = Quaternion.Euler(0f, 0f, angle);
        DrawBoxCastBox(origin, size / 2f, angle_z, direction, distance, color, duration);
    }

    public static void DrawCircleCast2D(Vector2 center, float radius, Color color, float duration)
    {
        ...
        Debug.DrawLine(previousPoint, center + new Vector2(radius, 0), color, duration);
    }
}